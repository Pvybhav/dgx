                    ...
                    if(((JasonViewActivity) context).model.var.has(component.getString("name"))){
                        ...
                        if(component.has("value")){
                            //try{
                                ...
                                Log.i("Switch Control", "Value field Selected as" + checked);
//                            }
//                            catch (Exception e)
//                            {
//                                if(component.has("defaultSelected")){
//                                    checked = component.getBoolean("defaultSelected");
//                                    Log.i("Switch Control", "Default field Selected as" + checked);
//                                }
//                                Log.i("Switch error log", "Incaompatable boolean field" + e.getMessage());
//                            }
                        }
                        else
                        {
